...
* И я заполняю реквизит “Дата”
	И в поле с именем 'Дата' я ввожу текст "07.05.2025  0:00:00"
...
* И я заполняю реквизит “Клиент”
	...
	И в таблице "Список" я выбираю текущую строку 
		Если таблица  "Список" не содержит строки Тогда
			...
			И в поле с именем 'Наименование' я ввожу текст 'ООО "Пряник"'
			...
			| 'Заказчики'    |
			И в таблице "Список" я выбираю текущую строку 
			И в поле с именем 'ИНН' я ввожу текст '999999999999'
			И в поле с именем 'КПП' я ввожу текст '999999999'
			И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
...
* И в списке документов вижу новый созданный и проведенный документ “Обслуживание клиента”
	И таблица "Список" содержит строки по шаблону:
		...
		| '07.05.2025 *' | '$$$$НомерДокумента$$$$' | 'ООО "Пряник"' | 'Иванов И.А. спец' | '13.05.2025'            |
...
Функционал: тестирование дополнения нового документа "Обслуживание клиента"

Как студент я хочу
автоматизировать тестирование дополнение  документа "Обслуживание клиента"
чтобы выполнить задание   
...
Сценарий: Я дополняю создание документа Обслуживаний клиента
* И я открываю форму списка документа “Обслуживание клиента”
	И В командном интерфейсе я выбираю "Обслуживание клиентов" "Обслуживание клиента"
	Тогда открылось окно "Обслуживание клиента"
	И в таблице "Список" я перехожу к строке
...
Функционал: тестирование обработки "Массовое создание актов"

Как студент я хочу
автоматизировать тестирование дополнение обработки "Массовое создание актов"
чтобы выполнить задание   
...
Сценарий: Я проверяю работу обработки Массовое создание актов
...
Сценарий: Я проверяю работу формирования отчёта Анализ выставленных актов
